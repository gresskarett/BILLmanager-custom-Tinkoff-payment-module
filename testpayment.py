...
from payment import PaymentCgi, generate_token
...
class TestPaymentCgi(PaymentCgi):
    ...
    def Process(self):
        ...
        #     request_body=request_body, password="TinkoffBankTest")})
        request_body.update({"Token": generate_token(
        ...
        if not kassa_response.get("Success"):
            payment.set_canceled(payment_id=self.elid,
                                 info=kassa_response.get("Message") + " "\
