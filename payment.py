...
def generate_token(request_body: t.Dict[str, t.Union[str, int]], password: str
                   ) -> str:
    """
    ...
    """
    # Собрать массив передаваемых данных в виде пар Ключ-Значения.
    token_dict: t.Dict[str, t.Union[str, int]] = dict(request_body)
    # Добавить в массив пару {Password, Значение пароля}.
    ...
    token_dict.update({"Password": password})
    ...
    token_str: str = reduce(lambda v1, v2: v1 + v2, token_dict.values())
    ...
    token_str = sha256(token_str.encode("utf-8")).hexdigest()
